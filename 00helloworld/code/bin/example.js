...
var Main = function() {
	...
	(Http__0||require("http")).createServer(function(request,response) {
		response.writeHead(200,{ 'Content-Type' : "text/plain"});
		response.end("Hello World\nresponse: " + Std.string(Type["typeof"](response)));
	}).listen(8080);
...
var Server__4 = require("http").Server;
...
var Duplex__8 = require("stream").Duplex;
var Readable__9 = require("stream").Readable;
